      ...
      <div className="footer-container">
        <div className="footer-columns">
          <div className="footer-column">
            <div className="footer-column-header">О КОМПАНИИ</div>
            <div className="column-item">Партнёрская программа</div>
            <div className="column-item">Вакансии</div>
          </div>
          <div className="footer-column">
            <div className="footer-column-header">МЕНЮ</div>
            <div className="footer-sub-menu-columns">
              <div className="footer-sub-menu-column">
                <div className="column-item">Расчёт стоимости</div>
                <div className="column-item">Услуги</div>
                <div className="column-item">Виджеты</div>
                <div className="column-item">Интеграции</div>
                <div className="column-item">Наши клиенты</div>
              </div>
              <div className="footer-sub-menu-column">
                <div className="column-item">Кейсы</div>
                <div className="column-item">Благодарственные письма</div>
                <div className="column-item">Сертификаты</div>
                <div className="column-item">Блог на Youtube</div>
                <div className="column-item">Вопрос / Ответ</div>
              </div>
            </div>
          </div>
          <div className="footer-column">
            <div className="footer-column-header">КОНТАКТЫ</div>
            <div className="phone-footer">+7 555 555-55-55</div>
            <div className="icons-group-footer">
              <svg
            ...
            <p className="text-wrapper">Москва, Путевой проезд 3с1, к 902</p>
          </div>
        </div>
